...
\title[S. N. A. E. L.]
{
\parbox{.25\textwidth}{\includegraphics[height=6cm]{UPLogo.png}\hfill}%
\parbox{.5\textwidth}{\centering \huge Frühwarnung vor Vulkanausbrüchen\hfill}%
\parbox{.23\textwidth}{\hfill\includegraphics[height=6cm]{InstitutLogo.png}}%
}
...
\vskip 5mm
  ...
  \begin{block}{\LARGE 3. Seismische Signale begleiten Vulkanausbrüche}
    \vskip 5mm
  		...
  		\begin{figure}
  		\begin{tikzpicture} 
  		\node[anchor=south west,inner sep=0] at (0,0){\includegraphics[scale=4.5]{images/5.jpg}};
  ...
  (10,6.5) -- node[right=50pt] {\LARGE Amplitude} (10,10);
 		...
 		\begin{figure}
 		\begin{tikzpicture} 
  		\node[anchor=south west,inner sep=0] at (0,0){\includegraphics[scale=4.5]{images/6.jpg}};
...
%\vskip 10mm
  \begin{figure}
  \begin{tikzpicture}
  \node[anchor=south west,inner sep=0] at (0,0) { \includegraphics[width=49cm, height=21cm]{images/9.jpg}};
...
\draw[blue, decoration={brace,mirror,amplitude=50pt,raise=50pt},decorate]
  (32.5,17) -- node[above=100pt] {\LARGE Frühwarnung} (5.5,17);
  
  \draw[blue, decoration={brace,mirror,amplitude=50pt,raise=30pt},decorate]
  (45,17) -- node[above=100pt] {\LARGE Frühwarnung} (43,17);
...
%  
%  \begin{tikzpicture}
%  \node[anchor=south west,inner sep=0] at (0,0) { \includegraphics[trim=0.2cm 0cm 0cm 0.5cm, clip,scale=2.2]{images/7.jpg}};
